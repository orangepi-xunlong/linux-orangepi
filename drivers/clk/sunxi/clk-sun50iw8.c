...
static const char *de_parents[] = {"pll_periph0x2"};
...
static const char *lpsd_parents[] = {"hosc", "pll_audio"};
static const char *ir_parents[] = {"losc", "hosc"};
...
SUNXI_CLK_PERIPH(gmac,           0,               0,       0,            0,                  0,         4,          8,          2,          0,          GMAC_CFG,        GMAC_GATE,      GMAC_GATE,         0,          31,         16,         0,             0,             &clk_lock, NULL,             0);
...
struct periph_init_data sunxi_periphs_init[] = {
	...
	{"gmac",           0,                    cpurapbs2_pll_parents,  ARRAY_SIZE(cpurapbs2_pll_parents),  &sunxi_clk_periph_gmac             },
...
struct periph_init_data sunxi_periphs_cpus_init[] = {
	...
	{"cpurcir",         CLK_GET_RATE_NOCACHE,               ir_parents,             ARRAY_SIZE(ir_parents),             &sunxi_clk_periph_cpurcir       },

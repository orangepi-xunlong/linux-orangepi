...
SUNXI_CLK_FACTORS1(pll_32k,        8,  8,  0,  0,  0,  0,  16, 6,  1,  1,  0,  1,    0,    0,  0,      31,     24,     0,      0,              0xc00121ff,  23,  27);
...
struct factor_init_data sunxi_factos[] = {
	...
	{"pll_32k",     hosc_parents, 1,          0,                    PLL_32K,     PLL_32K,     LOCKBIT(28), PLL_32K,     29,          PLL_LOCK_NEW_MODE, &sunxi_clk_factor_pll_32k,   NULL,   NULL,      (struct clk_ops *)NULL},
};

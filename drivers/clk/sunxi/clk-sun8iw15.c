...
SUNXI_CLK_PERIPH(dmic_rst,	     NULL,		      0,       0,            0,		             0,         0,          0,          0,          0,          0,		         DMIC_GATE,       0,		        0,          0,          16,         0,             0,             &clk_lock, NULL,             0);
...
struct periph_init_data sunxi_periphs_init[] = {
	...
	{"dmic_rst",	   0,                    audio_parents,          ARRAY_SIZE(audio_parents),          &sunxi_clk_periph_dmic_rst		    },

...
#define DEV_DBG_EN      0
#ifdef DEV_DBG_EN
#define vfe_dev_dbg(x, arg...)	printk("[OV2710_xc6130]"x,	##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...)	printk("[OV2710_xc6130]"x,	##arg)
#define vfe_dev_print(x, arg...)	printk("[OV2710_xc6130 ]"x,	##arg)
...
static int sensor_init_restart(struct v4l2_subdev *sd, u32 val);
...
static int sensor_s_night_or_not(struct v4l2_subdev *sd, __s32 *value)
{
	...
	vfe_dev_dbg("data = %d night_mode %d\n" , regs.data, night_mode);
...
static int sensor_detect(struct v4l2_subdev *sd)
{
	...
	vfe_dev_dbg("OV2710_xc6130 chip  ID =%x\n ", regs.data);
...
{
	int ret;
	vfe_dev_dbg("sensor_init_restart\n");

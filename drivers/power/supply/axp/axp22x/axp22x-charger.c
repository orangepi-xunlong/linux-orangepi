...
static void axp22x_private_debug(struct axp_charger_dev *cdev)
{
	...
	if (ocv_percent == 100 && cdev->charging == 0 && cdev->rest_vol == 99
	...
	if (ocv_percent == 100 && coulumb_percent == 100 && axp22x_config.ocv_coulumb_100 == 1) {
		cdev->rest_vol = 100;
	}
}

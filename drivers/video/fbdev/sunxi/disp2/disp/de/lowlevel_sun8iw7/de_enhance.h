...
int de_peak_set_window(unsigned int sel, unsigned int chno, unsigned int win_enable, struct de_rect window);
int de_peak_set_para(unsigned int sel, unsigned int chno, unsigned int gain, unsigned int hp_ratio,
						unsigned int bp0_ratio);
int de_peak_info2para(unsigned int sharp, struct de_rect window, struct __peak_config_data *para);
...
int de_lti_set_window(unsigned int sel, unsigned int chno, unsigned int win_enable, struct de_rect window);
int de_lti_set_para(unsigned int sel, unsigned int chno, unsigned int gain);
int de_lti_info2para(unsigned int gain, struct de_rect window, struct __lti_config_data *para);
...
int de_fce_info2para(unsigned int detail, unsigned int auto_contrast, unsigned int auto_color, struct de_rect window, __fce_config_data *para);
...
int de_ase_set_window(unsigned int sel, unsigned int chno, unsigned int win_enable, struct de_rect window);
int de_ase_set_para(unsigned int sel, unsigned int chno, unsigned int gain);
int de_ase_info2para(unsigned int auto_color, struct de_rect window, struct __ase_config_data *para);
...
int de_fcc_set_window(unsigned int sel, unsigned int chno, unsigned int win_en, struct de_rect window);
...
int de_fcc_info2para(unsigned int sgain0, unsigned int sgain1, unsigned int sgain2, unsigned int sgain3, unsigned int sgain4, unsigned int sgain5, struct de_rect window, __fcc_config_data *para);

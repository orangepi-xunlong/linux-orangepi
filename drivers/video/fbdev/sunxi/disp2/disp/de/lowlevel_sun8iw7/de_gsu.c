...
int de_gsu_set_para(unsigned int sel, unsigned int chno, unsigned int enable,
					unsigned int in_w, unsigned int in_h, unsigned int out_w, unsigned int out_h, struct scaler_para *para)
{
	unsigned int pt_coef;
	unsigned int chno_t;
...
/*********************************************************************************************************************
*function       : de_gsu_calc_scaler_para(struct de_rect64 crop, struct de_rect frame, struct de_rect *crop_fix,struct scaler_para *para)
...
*                  success
*********************************************************************************************************************/
int de_gsu_calc_scaler_para(struct de_rect64 crop, struct de_rect frame, struct de_rect *crop_fix, struct scaler_para *para)
{
...
/*********************************************************************************************************************
* function       : de_gsu_sel_ovl_scaler_para(unsigned char *en, struct scaler_para *layer_scale_para[], struct scaler_para *ovl_scale_para)
...
*                success
*********************************************************************************************************************/
int de_gsu_sel_ovl_scaler_para(unsigned char *en, struct scaler_para *layer_scale_para, struct scaler_para *ovl_scale_para)
{

...
static int de_icsc_set_reg_base(unsigned int sel,
...
int de_ccsc_apply(unsigned int sel, unsigned int ch_id, struct disp_csc_config *config)
{
	...
	de_csc_coeff_calc(in_fmt, in_mode, out_fmt, out_mode, config->brightness, config->contrast, config->saturation, config->hue, config->out_color_range, csc_coeff);
...
***************************************************************************/
int de_csc_coeff_calc(unsigned int infmt, unsigned int incscmod, unsigned int outfmt, unsigned int outcscmod, unsigned int brightness, unsigned int contrast, unsigned int saturation, unsigned int hue, unsigned int out_color_range, int *csc_coeff)
{
	...
	/*NON-BYPASS*/
	if (infmt == DE_RGB) {	/*convert to YCbCr*/
		if (outfmt == DE_RGB) {

...
static volatile struct __peak_reg_t *peak_dev[DEVICE_NUM][CHN_NUM];
 ...
 *                  success
 ******************************************************************************/
int de_peak_set_size(unsigned int sel, unsigned int chno,
	unsigned int width, unsigned int height)
{
 ...
 *                  unsigned int win_enable, struct struct de_rect window)
...
/*******************************************************************************
 * function       : de_peak_info2para(unsigned int sharp, struct struct de_rect window,

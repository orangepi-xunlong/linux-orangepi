...
#define SUNXI_RESET_TIME_MIN_NS 42
#define SUNXI_RESET_TIME_MAX_NS 327000

#define SUNXI_T1H_MIN_NS 42
#define SUNXI_T1H_MAX_NS 2560

#define SUNXI_T1L_MIN_NS 42
#define SUNXI_T1L_MAX_NS 1280

#define SUNXI_T0H_MIN_NS 42
#define SUNXI_T0H_MAX_NS 1280

#define SUNXI_T0L_MIN_NS 42
#define SUNXI_T0L_MAX_NS 2560

#define SUNXI_WAIT_TIME0_MIN_NS 42
#define SUNXI_WAIT_TIME0_MAX_NS 10000

#define SUNXI_WAIT_TIME1_MIN_NS 42
#define SUNXI_WAIT_TIME1_MAX_NS 85000000000

#define SUNXI_WAIT_DATA_TIME_MIN_NS 42
...
struct sunxi_ledc_trans_mode {
	char *str;
	enum sunxi_ledc_trans_mode_val val;
};

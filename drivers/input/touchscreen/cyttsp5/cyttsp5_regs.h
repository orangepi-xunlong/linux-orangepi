...
#define CY_FW_FILE_P00_NAME		"cyttsp5_fw_pid00.bin"
//added by pengwei 20190508 end

//added by pengwei 20190425 begin
#define CYTTSP5_DISABLE_SILK_KEY_REPORT
//#define CYTTSP5_DISABLE_WATCHDOG_MACRO

#define CYTTSP5_MACRO_FOR_EPD106

#define CYTTSP5_ENABLE_EDGE_CORRECTION
#define CYTTSPT_EDGE_WIDTH_FOR_CORRECTION		45

//#define TOUCH_PANEL_WAKEUP_SYSTEM_BY_BTN_TOUCH
//added by pengwei 20190425 end
...
//delete by pengwei 20190114 begin
#if 0
...
#endif
//delete by pengwei 20190114 end
...
*/
// linux version < 3.3.0 always false
...
struct cyttsp5_core_data {
	...
	volatile int hid_cmd_state;
	volatile int hid_reset_cmd_state; /* reset can happen any time */

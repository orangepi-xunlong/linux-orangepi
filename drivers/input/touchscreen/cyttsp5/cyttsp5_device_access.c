				  ...
				  struct cmcp_data *cmcp_info)
{
	...
	if (cp_tx_ave_data_panel != 0)
		cmcp_info->cp_sensor_tx_delta = ABS(
							(cp_tx_cal_data_panel[0] - cp_tx_ave_data_panel) * 1000
							/ cp_tx_ave_data_panel);
	...
	if (cp_rx_ave_data_panel != 0)
		cmcp_info->cp_sensor_rx_delta = ABS(
							(cp_rx_cal_data_panel[0] - cp_rx_ave_data_panel) * 1000
							/ cp_rx_ave_data_panel);

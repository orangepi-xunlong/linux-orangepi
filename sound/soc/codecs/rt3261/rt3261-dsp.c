...
static const u16 rt3261_dsp_init[][2] = { //set {0x22ee, 0x0001}, for R Channel source
	{0x3fd2, 0x0038}, {0x3fd2, 0x0038}, {0x229c, 0x0fa0}, {0x22d2, 0x8400},
	{0x22ee, 0x0000}, {0x22f2, 0x0040}, {0x22f5, 0x8000}, {0x22f6, 0x0000},
	{0x22f9, 0x007f}, {0x2310, 0x0880},
};
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		pr_err("snd_soc_read(codec,RT3261_DUMMY_PR3F)=0x%x\n",tmp);

...
#define RK_ES8316_WIDGETS \
	SND_SOC_DAPM_HP("Headphone", NULL)

	//SND_SOC_DAPM_SPK("Speaker", NULL)

static const struct snd_soc_dapm_widget rk_es8316_dapm_widgets[] = {
	RK_ES8316_WIDGETS,
};

#define RK_ES8316_AUDIO_MAP \
	{"Headphone", NULL, "HPOL"}, \
	{"Headphone", NULL, "HPOR"}
	//{"Speaker", NULL, "SPKL"},
	//{"Speaker", NULL, "SPKR"}

static const struct snd_soc_dapm_route rk_es8316_audio_map[] = {
	//RK_ES8316_AUDIO_MAP,
};

#define RK_ES8316_CONTROLS \
	SOC_DAPM_PIN_SWITCH("Headphone")

	//SOC_DAPM_PIN_SWITCH("Speaker")

static const struct snd_kcontrol_new rk_es8316_controls[] = {
	RK_ES8316_CONTROLS,
};
...
{
	/*
	 * The jack has already been created in the rk_8316_headset_init()
	 * function.
	 */
...
/* es8316 dai_link */
static struct snd_soc_dai_link rk_es8316_dailinks[] = {
	{
		.name = "es8316",
		.stream_name = "Analog",
		.init = rk_init,
...
static int rk_8316_headset_init(struct snd_soc_component *component);

static struct snd_soc_aux_dev rk_8316_headset_dev = {
	.dlc = COMP_EMPTY(),
	.init = rk_8316_headset_init,
};

static struct snd_soc_card rockchip_es8316_card = {
	.name = "ROCKCHIP-I2S",
	.owner = THIS_MODULE,
	.dai_link = rk_es8316_dailinks,
	.num_links = ARRAY_SIZE(rk_es8316_dailinks),
	.aux_dev = &rk_8316_headset_dev,
	.num_aux_devs = 1,
	.dapm_widgets = rk_es8316_dapm_widgets,
	.num_dapm_widgets = ARRAY_SIZE(rk_es8316_dapm_widgets),
	.dapm_routes = rk_es8316_audio_map,
	.num_dapm_routes = ARRAY_SIZE(rk_es8316_audio_map),
	.controls = rk_es8316_controls,
	.num_controls = ARRAY_SIZE(rk_es8316_controls),
};
...
{
	rk_8316_headset_dev.dlc.of_node = of_parse_phandle(
			np, "rockchip,headset-codec", 0);
	if (!rk_8316_headset_dev.dlc.of_node) {
		dev_err(dev,
...
static const struct of_device_id rockchip_es8316_of_match[] = {
	{ .compatible = "rockchip,rockchip-audio-es8316", },
	{},
};

...
#define RTKBT_RELEASE_NAME "20220818_LINUX_BT_DRIVER"
#define VERSION "1.0"
...
static int __init h5_init(void)
{
	int err = hci_uart_register_proto(&h5);
	BT_INFO("RTKBT_RELEASE_NAME: %s", RTKBT_RELEASE_NAME);
...
static void __exit h5_deinit(void)
{
	hci_uart_unregister_proto(&h5);
}

module_init(h5_init);
module_exit(h5_deinit);

MODULE_AUTHOR("Realtek Corporation");
MODULE_DESCRIPTION("Realtek Bluetooth HCI UART H5 Driver");

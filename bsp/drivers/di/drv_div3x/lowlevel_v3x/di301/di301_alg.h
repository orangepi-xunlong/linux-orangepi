...
struct __itd_alg_para {
	...
	/* non-22 detect */
	unsigned int match_th;
	unsigned int interlace_th1;
	unsigned int interlace_th2;
	unsigned int progressive_th1;
	unsigned int progressive_th2;

	unsigned int pd_th1;
	unsigned int pd_th2;
	unsigned int pd_th3;
	unsigned int m_pd_th;
	unsigned int id_th1;
	unsigned int id_th2;
	unsigned int id_th3;
	unsigned int m_id_th;
};
...
struct __itd_alg_hist {
	unsigned int is_progressive_lock;

	//yangqinglian for ITD
	unsigned int field03_diff[2];
	unsigned int field12_diff[2];
	unsigned int field30_diff[2];
	unsigned int field21_diff[2];
	unsigned int intra_frame_diff[2];

	/*idet  yangqinglian  */
	FileType history[4];
	FileType last_type;
	unsigned int single_tatal[4];
	unsigned int multiple_tatal[4];
	unsigned int interlaced_frame;
	unsigned int s_cnt_p;
	unsigned int cnt_p;
	unsigned int s_cnt_i;
	unsigned int cnt_i;
	unsigned int m_cnt_p0;
	unsigned int m_cnt_i0;
};
...
struct __itd_hist {
	...
	u32 FMD_FID23;	/* 0x1e4 */
	// yangqinglian: for ITD
	unsigned int field03_diff;
	unsigned int field12_diff;
	unsigned int intra_frame_diff;
	unsigned int field30_diff;
	unsigned int field21_diff;
};

...
#ifndef _DI301_REG_H_
#define _DI301_REG_H_
...
struct md_reg {
	union md_para_reg md_para;                     /* 0x000 */
	union md_confpar0_reg md_confpar0;             /* 0x004 */
	union md_confpar1_reg md_confpar1;             /* 0x008 */
	union md_confpar2_reg md_confpar2;             /* 0x00c */
	u32 md_res[5];                                 /* 0x010 */
	union win_horz_reg md_croph;                   /* 0x024 */
	union win_vert_reg md_cropv;                   /* 0x028 */
};

struct dit_reg {
	union dit_setting_reg dit_setting;             /* 0x000 */
	union dit_chroma_md_para0_reg dit_chr_para0;   /* 0x004 */
	union dit_chroma_md_para1_reg dit_chr_para1;   /* 0x008 */
	union dit_intra_intp_reg dit_intra_para;       /* 0x00c */
	union dit_inter_intp_reg dit_inter_para;       /* 0x010 */
	union win_horz_reg dit_croph;                  /* 0x014 */
	union win_vert_reg dit_cropv;                  /* 0x018 */
	union win_horz_reg dit_demoh;                  /* 0x01c */
	union win_vert_reg dit_demov;                  /* 0x020 */
};

struct fmd_reg {
	union fmd_diff_th0_reg fmd_diff_th0;           /* 0x000 */
	union fmd_diff_th1_reg fmd_diff_th1;           /* 0x004 */
	union fmd_diff_th2_reg fmd_diff_th2;           /* 0x008 */
	union fmd_fid_hist_reg fmd_fid12;              /* 0x00c */
	union fmd_fid_hist_reg fmd_fid23;              /* 0x010 */
	union fmd_fid_hist_reg fod_fid30;              /* 0x014 */
	union fmd_fid_hist_reg fod_fid32;              /* 0x018 */
	union fmd_fid_hist_reg fod_fid10;              /* 0x01c */
	union fmd_fid_hist_reg fod_fid12;              /* 0x020 */
	union fmd_frd_hist_reg fmd_frd02;              /* 0x024 */
	union fmd_frd_hist_reg fmd_frd13;              /* 0x028 */
	union fmd_feat_th0_reg fmd_feat_th0;           /* 0x02C */
	union fmd_feat_th1_reg fmd_feat_th1;           /* 0x030 */
	union fmd_feat_th2_reg fmd_feat_th2;           /* 0x034 */
	union fmd_mot_th_reg fmd_mot_th;               /* 0x038 */
	union fmd_text_th_reg fmd_text_th;             /* 0x03c */
	union fmd_blk_th_reg fmd_blk_th;               /* 0x040 */
	union fmd_row_th_reg fmd_row_th;               /* 0x044 */
	union fmd_field_hist_reg fmd_field_hist0;      /* 0x048 */
	union fmd_field_hist_reg fmd_field_hist1;      /* 0x04c */
	union fmd_glb_set_reg fmd_glb;                 /* 0x050 */
	u32 fmd_field03_cumul;                         /* 0x054 */
	u32 fmd_field12_cumul;                         /* 0x058 */
	u32 fmd_fieldtop_cumul;                        /* 0x05c */
	u32 fmd_fieldbot_cumul;                        /* 0x060 */
	u32 fmd_intrafrm_cumul;                        /* 0x064 */
	u32 fmd_field30_cumul;                         /* 0x068 */
	u32 fmd_field21_cumul;                         /* 0x06c */
	union win_horz_reg fmd_croph;                  /* 0x070 */
	union win_vert_reg fmd_cropv;                  /* 0x074 */
};

struct tnr_reg {
	union tnr_strength_reg tnr_strength;           /* 0x000 */
	union tnr_dark_th_reg tnr_dark_th;             /* 0x004 */
	union tnr_dark_protect_reg tnr_dark_protect;   /* 0x008 */
	union tnr_dark_para_reg tnr_dark_para_y;       /* 0x00c */
	union tnr_dark_para_reg tnr_dark_para_u;       /* 0x010 */
	union tnr_dark_para_reg tnr_dark_para_v;       /* 0x014 */
	union tnr_fth_detect_reg tnr_fth_detect;       /* 0x018 */
	union tnr_dt_filter_reg tnr_dt_filter;         /* 0x01c */
	union tnr_weight_lbound_reg tnr_weight_lbound; /* 0x020 */
	union tnr_abn_detect_reg tnr_abn_detect;       /* 0x024 */
	union tnr_th_sum_reg tnr_th_sum;               /* 0x028 */
	u32 tnr_sum_weight_y;                          /* 0x02c */
	u32 tnr_sum_weight_u;                          /* 0x030 */
	u32 tnr_sum_weight_v;                          /* 0x034 */
	u32 tnr_sum_gain_y;                            /* 0x038 */
	u32 tnr_sum_gain_u;                            /* 0x03c */
	u32 tnr_sum_gain_v;                            /* 0x040 */
	u32 tnr_sum_still_out;                         /* 0x044 */
	u32 tnr_sum_weight_y_cnt;                      /* 0x048 */
	u32 tnr_sum_gain_y_cnt;                        /* 0x04c */
	union tnr_th_dark_dither_reg tnr_th_dark_dth;  /* 0x050 */
	union tnr_random_func_cfg_reg tnr_random_cfg;  /* 0x054 */
	u32 tnr_random_gen;                            /* 0x058 */
	union tnr_md_result_reg tnr_md_result;         /* 0x05c */
	union win_horz_reg tnr_croph;                  /* 0x060 */
	union win_vert_reg tnr_cropv;                  /* 0x064 */
	union win_horz_reg tnr_demoh;                  /* 0x068 */
	union win_vert_reg tnr_demov;                  /* 0x06c */
};

/* register of di301 */
struct di_reg {
	struct top_reg *top_reg;
	struct md_reg  *md_reg;
	struct dit_reg *dit_reg;
	struct fmd_reg *fmd_reg;
	struct tnr_reg *tnr_reg;
};

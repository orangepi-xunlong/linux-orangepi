...
#define RF_API_TABLE_VERSION        (0x0005) // It should be incremented after structure st_rf_table change.
...
struct st_rf_table
{
    ...
    struct st_tempe_table ht_2_config;
    struct st_tempe_table lt_2_config;
    struct st_ble_tempe_table ble_ht_2_config;
    struct st_ble_tempe_table ble_lt_2_config;
    int8_t low_2_boundary;
    int8_t high_2_boundary;
}SSV_PACKED_STRUCT_STRUCT;
SSV_PACKED_STRUCT_END

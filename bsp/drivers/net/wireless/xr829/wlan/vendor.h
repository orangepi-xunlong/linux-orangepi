...
enum nl80211_vendor_subcmds {
	NL80211_VENDOR_SUBCMD_UNSPEC  = 0,
	NL80211_VENDOR_SUBCMD_SET_PMK = 4,
	NL80211_VENDOR_SUBCMD_SET_MAC = 6,
	NL80211_VENDOR_SCMD_ACS       = 9,
	NL80211_VENDOR_SCMD_MAX       = 10,
...
enum wlan_vendor_attr {
	WLAN_VENDOR_ATTR_DRIVER_CMD        = 0,
	WLAN_VENDOR_ATTR_DRIVER_KEY_PMK    = 1,
	WLAN_VENDOR_ATTR_DRIVER_MAC_ADDR   = 3,
	/* used by NL80211_VENDOR_SUBCMD_GET_FEATURES */
	WLAN_VENDOR_ATTR_FEATURE_FLAGS     = 7,
	WLAN_VENDOR_ATTR_DRIVER_AFTER_LAST,
	WLAN_VENDOR_ATTR_DRIVER_MAX        =
	WLAN_VENDOR_ATTR_DRIVER_AFTER_LAST - 1,
};

...
#define WF_DBG(msg, fmt...)		DE_DEBUG(msg, ##fmt)
#define WF_INFO(msg, fmt...)		DE_INFO(msg, ##fmt)
#define WF_WRN(msg, fmt...)		DE_WARN(msg, ##fmt)
#define WF_ERR(msg, fmt...)		DE_WARN(msg, ##fmt)
#else

...
/* sound\soc\sunxi\snd_sunxi_pcm_loopback.h
...
#ifndef __SND_SUNXI_PCM_LOOPBACK_H
#define __SND_SUNXI_PCM_LOOPBACK_H
...
extern int snd_sunxi_dma_platform_loopback_register(struct device *dev);
extern void snd_sunxi_dma_platform_loopback_unregister(struct device *dev);

#endif /* __SND_SUNXI_PCM_LOOPBACK_H */

...
#define GPIO_IR_DEVICE_NAME	"sunxi_gpio_ir_recv"
...
static int gpio_ir_recv_probe(struct platform_device *pdev)
{
	...
	gpio_dev->active_low = gpiod_get_value(gpio_dev->gpiod);
	...
	return devm_request_irq(dev, gpio_dev->irq, gpio_ir_recv_irq,
				...
				"sunxi-gpio-ir-recv-irq", gpio_dev);
}
...
MODULE_AUTHOR("chengweipeng <chengweipeng@allwinnertech.com>");
